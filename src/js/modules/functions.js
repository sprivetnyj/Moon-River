...
// Массив из параметров data-атрибута

export function arrayFromData(element, data) {
	return element.getAttribute(data).split(',');
}

//================================================================================

// Срабатывание media-запроса


//================================================================================

// Сниппет "df"
// Файл fullscreen.scss
...
//   {true} - скрывать
//   {false} - не скрывать
//  @point - со скольки пикселей начинать прокрутку
...
export function headerScroll() {
	const header = document.querySelector('header[data-header-scroll]');
	if (header) {
		const headerData = arrayFromData(header, 'data-header-scroll');
